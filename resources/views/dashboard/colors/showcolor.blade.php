            ...
            <div class="box-body">
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($colors as $color)
                        ...
                        <tr>
                        	<td style="width: 10px" >{{ $color->id }}</td>
                            <td >{{ $color->name }}</td>
                           
							 <td style="width: 15%;"><span class="btn-edit">

                                    <a href="{{ url('dashboard/editcolors/'.$color->id) }}" class="btn btn-xs btn-warning" data-toggle="tooltip"  data-original-title="Edit"><i class="fa fa-edit"></i> </a>

                                    {!! Form::open(['action'=>['ColorController@destroy',$color->id],'method'=>'delete','style'=>'display:inline;']) !!}
